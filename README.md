...
* Use SIFT to detect correspondence between pair of images and calculate the keypoints.
...
* Triangulate using the fact that x1 = P1X and x2 = P2X, where X is the 3D point and x1, x2 are points on the images.
